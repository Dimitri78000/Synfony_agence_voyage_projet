 ...
 */
class BackofficeProgrammationController extends AbstractController
{
    /**
    ...
    public function edit(Request $request, ProgrammationCircuit $programmationCircuit): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('programmation_circuit_edit', ['id' => $programmationCircuit->getId()]);
        }
